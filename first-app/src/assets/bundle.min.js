...
/******/ 		return __webpack_require__.p + "static/js/" + chunkId + ".bundle.min.js"
/******/ 	}
/******/
...
// CONCATENATED MODULE: ./src/redux/form/form.types.js
var FormActionTypes={ADD_FORM:'ADD_FORM',REMOVE_FORM:'REMOVE_FORM'};
// CONCATENATED MODULE: ./src/redux/form/form.reducer.js
var INITIAL_STATE={forms:[]};var form_reducer_formReducer=function formReducer(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:INITIAL_STATE;var action=arguments.length>1?arguments[1]:undefined;switch(action.type){case FormActionTypes.ADD_FORM:return objectSpread2_objectSpread2(objectSpread2_objectSpread2({},state),{},{forms:state.forms.concat(action.payload)});case FormActionTypes.REMOVE_FORM:return objectSpread2_objectSpread2(objectSpread2_objectSpread2({},state),{},{// forms: state.forms.filter((form, i) => form.action.payload !== i )
forms:state.forms.filter(function(form){return form!==action.payload;})});default:return state;}};
// CONCATENATED MODULE: ./src/redux/rootreducer.js
var rootReducer=combineReducers({forms:form_reducer_formReducer});/* harmony default export */ var rootreducer = (rootReducer);
// CONCATENATED MODULE: ./src/redux/store.js
var middleware=[];var store_store;try{store_store=redux_createStore(rootreducer,applyMiddleware.apply(void 0,middleware));}catch(error){console.log('redux error',error);}/* harmony default export */ var redux_store = (store_store);
...
// EXTERNAL MODULE: ./src/components/Greeting/greeting.css
var greeting = __webpack_require__(18);

// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(1);

// CONCATENATED MODULE: ./src/components/Greeting/greeting.jsx
// import ReactDOM from 'react-dom'
// import reactToWebComponent from "react-to-webcomponent"
var greeting_Greeting=function Greeting(){return/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"greet",children:/*#__PURE__*/Object(jsx_runtime["jsx"])("h1",{children:"greetings from react"})});};// const ReactGreeting = reactToWebComponent(Greeting, React, ReactDOM)
// customElements.define('react-greet', ReactGreeting)
/* harmony default export */ var Greeting_greeting = (greeting_Greeting);
...
// CONCATENATED MODULE: ./src/redux/form/form.action.js
var form_action_addForm=function addForm(form){return{type:FormActionTypes.ADD_FORM,payload:form};};var form_action_removeForm=function removeForm(list){return{type:FormActionTypes.REMOVE_FORM,payload:list};};
// EXTERNAL MODULE: ./src/components/Form/Form.css
var Form_Form = __webpack_require__(20);

// CONCATENATED MODULE: ./src/components/Form/Form.jsx
var Form_Form_Form=function Form(){// const [lists, setList] = useState([])
var _useState=Object(react["useState"])(''),_useState2=_slicedToArray(_useState,2),data=_useState2[0],setData=_useState2[1];var dispatch=useDispatch();var lists=useSelector_useSelector(function(state){return state.forms.forms;});var handleChange=function handleChange(e){setData(e.target.value);};var handleSubmit=function handleSubmit(e){e.preventDefault();// const copy = [...lists, data]
// setList(copy)
dispatch(form_action_addForm(data));// addForm(data)
setData('');};var handleDelete=function handleDelete(list){// const copy = [...lists]
// copy.splice(list, 1)
dispatch(form_action_removeForm(list));// removeForm(list)
// setList(copy)
};return/*#__PURE__*/Object(jsx_runtime["jsxs"])("div",{children:[/*#__PURE__*/Object(jsx_runtime["jsxs"])("form",{className:"form",onSubmit:handleSubmit,children:[/*#__PURE__*/Object(jsx_runtime["jsx"])("label",{children:"Input"}),/*#__PURE__*/Object(jsx_runtime["jsx"])("input",{onChange:handleChange,type:"text",value:data}),/*#__PURE__*/Object(jsx_runtime["jsx"])("button",{children:"submit"})]}),/*#__PURE__*/Object(jsx_runtime["jsx"])("div",{className:"lists",children:lists.map(function(list,index){return/*#__PURE__*/Object(jsx_runtime["jsxs"])("div",{className:"list",children:[list,/*#__PURE__*/Object(jsx_runtime["jsx"])("span",{onClick:function onClick(){return handleDelete(list);},children:"X"})]},index);})})]});};// const mapStateToProps = state => ({
...
/* harmony default export */ var components_Form_Form = (Form_Form_Form);
// CONCATENATED MODULE: ./node_modules/webcomponents-redux/es/webcomponents-redux.js
function webcomponents_redux_typeof(obj) {
  "@babel/helpers - typeof";

  if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    webcomponents_redux_typeof = function _typeof(obj) {
      return typeof obj;
    };
  } else {
    webcomponents_redux_typeof = function _typeof(obj) {
  ...
  return webcomponents_redux_typeof(obj);
}
/**
...
var mixinConnectedCallback = {
  /**
   * Calls the existing connectedCallback lifecycle event when present, and connects to Redux store.
   */
  connectedCallback: function connectedCallback() {
    // @ts-ignore
    this.mixinExistingConnectedCallback && this.mixinExistingConnectedCallback(); // @ts-ignore
...
var mixinDisconnectedCallback = {
  /**
   * Calls the existing disconnectedCallback lifecycle event, and disconnect with Redux store.
   */
  disconnectedCallback: function disconnectedCallback() {
    // @ts-ignore
    this.mixinExistingDisconnectedCallback && this.mixinExistingDisconnectedCallback(); //@ts-ignore
...
var mixinWebcomponent = {
   ...
   */
  mixinConnectState: function mixinConnectState() {
    // Step 1: To the instance add dispatch functions as properties
    if (this.mapDispatchToProps) {
      var obj = this.mapDispatchToProps(this.mixinStore.dispatch);
    ...
    var nextState = this.mixinStore.getState();
    this.mapStateToProps && this.mapStateToProps(this.mixinState, nextState); // Step 3: Save the current state and subscribe to store change event
   ...
   */
  mixinDisconnectState: function mixinDisconnectState() {
   ...
   */
  mixinOnStateChange: function mixinOnStateChange() {
    var nextState = this.mixinStore.getState();
...
function webcomponents_redux_connect(className, mixinStore) {
  ...
  if (!(mixinStore && webcomponents_redux_typeof(mixinStore) === 'object')) {
    logError('webcomponents-redux: Invalid store object passed to connect');
    return;
  }

  if (!className.prototype.hasOwnProperty('mapStateToProps')) {
    logWarning("webcomponents-redux: ".concat(className.name, " is missing method mapStateToProps"));
  }

  if (!className.prototype.hasOwnProperty('mapDispatchToProps')) {
    logWarning("webcomponents-redux: ".concat(className.name, " is missing method mapDispatchToProps"));
  }
...
function App_App(){return/*#__PURE__*/Object(jsx_runtime["jsxs"])("div",{className:"App",children:[/*#__PURE__*/Object(jsx_runtime["jsx"])(Greeting_greeting,{}),/*#__PURE__*/Object(jsx_runtime["jsx"])(components_Form_Form,{})]});}function ReactApp(){return/*#__PURE__*/Object(jsx_runtime["jsx"])(App_App,{});}var App_ReactElement=/*#__PURE__*/function(_HTMLElement){_inherits(ReactElement,_HTMLElement);var _super=_createSuper(ReactElement);function ReactElement(){_classCallCheck(this,ReactElement);return _super.apply(this,arguments);}_createClass(ReactElement,[{key:"connectedCallback",value:function connectedCallback(){react_dom_default.a.render(/*#__PURE__*/Object(jsx_runtime["jsx"])(ReactApp,{}),this);}}]);return ReactElement;}(/*#__PURE__*/wrapNativeSuper_wrapNativeSuper(HTMLElement));webcomponents_redux_connect(App_ReactElement,redux_store);customElements.define('react-component',App_ReactElement);// const ReactGreeting = reactToWebComponent(App, React, ReactDOM);
// customElements.define("react-component", ReactGreeting)
// export default App;
// CONCATENATED MODULE: ./src/reportWebVitals.js
var reportWebVitals=function reportWebVitals(onPerfEntry){if(onPerfEntry&&onPerfEntry instanceof Function){__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 22)).then(function(_ref){var getCLS=_ref.getCLS,getFID=_ref.getFID,getFCP=_ref.getFCP,getLCP=_ref.getLCP,getTTFB=_ref.getTTFB;getCLS(onPerfEntry);getFID(onPerfEntry);getFCP(onPerfEntry);getLCP(onPerfEntry);getTTFB(onPerfEntry);});}};/* harmony default export */ var src_reportWebVitals = (reportWebVitals);
...
var react_router_dom_excluded = ["onClick", "reloadDocument", "replace", "state", "target", "to"],
    react_router_dom_excluded2 = ["aria-current", "caseSensitive", "className", "end", "style", "to"];
...
var Link = /*#__PURE__*/Object(react["forwardRef"])(function LinkWithRef(_ref3, ref) {
  var onClick = _ref3.onClick,
      ...
      target = _ref3.target,
      to = _ref3.to,
      rest = react_router_dom_objectWithoutPropertiesLoose(_ref3, react_router_dom_excluded);
...
var NavLink = /*#__PURE__*/Object(react["forwardRef"])(function NavLinkWithRef(_ref4, ref) {
  var _ref4$ariaCurrent = _ref4["aria-current"],
      ...
      to = _ref4.to,
      rest = react_router_dom_objectWithoutPropertiesLoose(_ref4, react_router_dom_excluded2);
...
react_dom_default.a.render(/*#__PURE__*/Object(jsx_runtime["jsx"])(components_Provider,{store:redux_store,children:/*#__PURE__*/Object(jsx_runtime["jsx"])(BrowserRouter,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(react_default.a.StrictMode,{children:/*#__PURE__*/Object(jsx_runtime["jsx"])(ReactApp,{})})})}),document.getElementById('root'));// If you want to start measuring performance in your app, pass a function
